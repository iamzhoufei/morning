...
import { FireWorksProp } from './model';

import './index.scss';

const FireWorks = (props: FireWorksProp) => {
  ...
  } // I didn't come up with these names, I took them from some website with color palettes :D
  ...
  var initGui = function initGui() {
    gui.width = 300;
    gui.closed = true;
    gui.add(parameters, 'colors', ['Night life']);
  ...
  function Particle(x, y) {
    ...
    var maxLife = parameters.maxLife,
    ...
    this.color = nightLife[Math.floor(Math.random() * nightLife.length)];
  ...
  canvas.addEventListener('touchmove', function (e) {
    var _e$touches2 = _slicedToArray(
  ...
  return <>
    {
      visible ? <View className='fireworks_wrapper'>烟花</View> : null
    }
  </>
}
